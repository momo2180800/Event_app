...
<body>
    <header class="connected">
      ...
      <section class="form">
        <form action="index.php?action=creerEvent" method="post" enctype="multipart/form-data">
            <div class="form-input">
                <input type="text" name="nom_event" placeholder="Nom de l'evenement" required>
            ...
            <div class="form-input">
                ...
                <label for="image" id="drop-area">
                    <input type="file" id="image" name="image_event" accept="image/*" hidden required>
                    <div id="upload-icon">
            ...
            <div class="form-input">
                ...
                <input type="text" name="location_event" placeholder="Localisation" required>
                <i class="fas fa-calendar"></i>
                <input type="date" name="date_event" placeholder="Date de l'evenement" required>
            </div>
            
            <div class="form-input">
                <i class="fas fa-clock"></i>
                <input type="time" name="heure_debut_event" placeholder="Heure de debut de l'evenement" required>
                <i class="fas fa-clock"></i>
                <input type="time" name="heure_fin_event" placeholder="Heure de fin de l'evenement" required>
            </div>
            <div class="form-input">
                <i class="fas fa-dollar-sign"></i>
                <input type="number" name="prix_event" placeholder="Prix de l'evenement">
                <i class="fas fa-users"></i>
                <input type="number" name="places_event" placeholder="Nombre de places" required>
            </div>
            <button type="submit" name="submit" class="btn_form">Creer l'evenement</button>
        </form>
      </section>    
    <footer>
