    ...
    <!--------------------------- Left Box ----------------------------->
       ...
       <div class="col-md-6 rounded-4 ">
           <div class="featured-image mb-3">
            <img src="vue/img/login.jpg" class="img-fluid" style="width: 100%; height: 500px; object-fit: cover">
           </div>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                <div class="header-text mb-4">
                     <h2>Connexion</h2>
                     <p>Saisissez votre adresse email et mot de passe</p>
                </div>
                ...
                <div class="row">
                    <small>Vous n'avez pas de compte? <a href="index.php?action=signup">S'inscrire ici</a></small>
                </div>
          </div>
       </div> 
